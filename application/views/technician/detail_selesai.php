<div class="container-fluid">
    <div class="clearfix">
        ...
        <div class="float-right">
            <a href="<?= base_url('technician/pesanan_selesai') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
        </div>
    </div>
    <hr>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <select name="teknisi" id="teknisi" class="form-control" readonly>
                                            <option><?= $transaksi->teknisi ?></option>
