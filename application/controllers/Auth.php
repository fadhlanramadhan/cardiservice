...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('phone', 'Phone', 'required|trim|is_unique[user.phone]|max_length[14]|integer', [
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => '191221012@mhs.stiki.ac.id',
            'smtp_pass' => 'prevabnet',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
        ...
        $this->email->from('cardi.something@gmail.com', 'Cardi Computer & Services');
    ...
    public function verify()
    {
        ...
        if ($user) {
            ...
            if ($user_token) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Account activation failed! Invalid</div>');
                redirect('auth');
            }
        } else {
